export class Configurations {
    ...
    public static SERVER_PATH = 'http://localhost/gised/src/app/server/server.php';
    public static SERVER_PATH_UPLOAD = 'http://localhost/gised/src/app/server/classesmodule/class.module.uploadFiles.php';
